...
setwd(paste('/data/scratch/btw863/bat-diet/data/processed_dna_data/lulu/', as.character(arg), sep =''))



otutab <- read.csv("all_post_QC_otus.txt.table.out",sep='\t',header=TRUE,as.is=TRUE, row.names = 1)
...
write.csv(curated_result$curated_table, paste('../', arg,'_output.csv', sep =''))
