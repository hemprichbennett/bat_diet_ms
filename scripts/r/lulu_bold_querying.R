...
mydata <- read.table("data/processed_dna_data/lulu/95/lulu_95.tsv", header = F, sep = "\t", dec = ".", stringsAsFactors = FALSE)
...
write.csv(outtaxframe, paste('data/lulutaxonomic_info', args,'.csv', sep = ''))
